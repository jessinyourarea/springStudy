...
/*
	요청: .do
	  DispatcherServlet
	   => HandlerAdapter : Model 클래스를 찾아주는 역할
	   => handlerMapping : @Getmapping, @PostMapping, @RequestMapping 찾아주는 역할
	                       => 찾아서 호출.
	  DispatcherServlet
...
public class SpringConfig implements WebMvcConfigurer {
	...
	*/
	...
	@Bean("ssf")
	public SqlSessionFactory selSessionFactory() throws Exception
	{
