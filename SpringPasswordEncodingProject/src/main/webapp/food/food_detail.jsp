...
<script type="text/javascript" src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=6a1ffbe66e5a8ba9af15d82e0b41ceac&libraries=services"></script>
    ...
    <div class="row">
      <div class="col-sm-7">
            ...
            <td>
              <table class="table" v-for="re in reply_data">
                <tr>
                  ...
                  <td class="text-right">
                    <span v-if="re.id==food_detail.sessionId">
                      <input type="button" class="btn btn-xs btn-primary" value="수정" @click="replyUpdateForm(re.no)" :id="'up'+re.no">
                ...
                <tr style="display:none" :id="'reply'+re.no" class="updates" >
                  <td colspan="2">
                    <textarea rows="5" cols="70" style="float:left" :id="'msg'+re.no">{{re.msg}}</textarea>
		            <input type=button value="댓글수정" 
		              style="height:105px;background-color:blue;color:white"
        ...
        <table class="table" v-if="food_detail.sessionId!=null">
          <tr>
            <td>
              <textarea rows="5" cols="70" style="float:left" ref="msg" v-model="msg"></textarea>
              <input type=button value="댓글쓰기" 
                style="height:105px;background-color:blue;color:white" @click="replying()">
            </td>
          </tr>
        </table>
      </div>
