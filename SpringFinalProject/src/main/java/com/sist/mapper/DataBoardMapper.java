...
public interface DataBoardMapper {
	...
	@Select("SELECT no,name,subject,content,TO_CHAR(regdate,'yyyy-mm-dd') as dbday, hit, filecount,filename,filesize "
	...
	/*
	 * @Select("SELECT content FROM springDataBoard WHERE " + "WHERE name=#{name}")
